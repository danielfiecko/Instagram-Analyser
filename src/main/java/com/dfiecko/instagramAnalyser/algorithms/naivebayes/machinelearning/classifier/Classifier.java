package com.dfiecko.instagramAnalyser.algorithms.naivebayes.machinelearning.classifier;
...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K>, java.io.Serializable {
     ...
     * probability.
     *
     * @see de.assets.machinelearning.classifier.Classifier#featureProbability(Object,
     *      Object)
     * @see de.assets.machinelearning.classifier.Classifier#featureWeighedAverage(Object,
